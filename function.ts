  ...
  : (
    ...
    ? (
      ...
      [(i: IO) => O, ...R] extends CG<[(i: IO) => O, ...R]> 
        ...
        // TODO: this currently duplicates the CG clause, we can maybe DRY this up
        : [h: (i: I) => IO, ...rest: CG<[(i: IO) => O, ...R]>]
    )
      : ( // Error case
       ...
       T extends [h: (i: infer I) => infer O, ...rest: infer R]
        ...
        : never // TODO: first arg is not a unary function, we should construct an appropriate type
    )
  )
...
cg4((i: string) => 3, (i: number) => i, (i: number) => i, (i: number) => i);
cg4((i: string) => 3, (i: number) => i, (i: number) => i, (i: number) => i, (i: string) => i, (i:string) => i);
